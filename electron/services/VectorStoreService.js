...
export class VectorStoreService {
  ...
  async initialize() {
    try {
      ...
      console.log(`VectorStore: Service initialized at ${this.dbPath}`);
    } catch (error) {
  ...
  async addDocument(text, metadata = {}) {
    try {
      ...
      console.log(`VectorStore: Added document: "${text.substring(0, 20)}..."`);
      return true;
    } catch (error) {
      console.error('VectorStore: Add document error:', error);
      return false;
    }
  }
